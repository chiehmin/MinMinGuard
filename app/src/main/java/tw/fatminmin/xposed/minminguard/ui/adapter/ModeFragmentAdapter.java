...
public final class ModeFragmentAdapter extends FragmentPagerAdapter
{
    ...
    private MainFragment[] mFragments = new MainFragment[]{
            MainFragment.newInstance(MainFragment.FragmentMode.AUTO), MainFragment.newInstance(MainFragment.FragmentMode.BLACKLIST), MainFragment.newInstance(MainFragment.FragmentMode.WHITELIST)
    };
